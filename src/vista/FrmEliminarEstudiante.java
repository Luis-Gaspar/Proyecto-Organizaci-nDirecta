...
public class FrmEliminarEstudiante extends javax.swing.JFrame {
    ...
    private void buscarRegistro() {
        ...
        if (datos != null) {
            ...
            cboSemestre.setSelectedItem(String.valueOf(Integer.parseInt(datos[3])));

            // Selecciona el radio button del grupo
    ...
    private void eliminar() {
        ...
        if (numControl.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Ingresa un número de control válido.");
            return;
        }

        int opcion = JOptionPane.showConfirmDialog(this,
                "¿Estás seguro de eliminar al estudiante con No. Control: " + numControl + "?",
                "Confirmar eliminación",
                JOptionPane.YES_NO_OPTION);

        if (opcion == JOptionPane.YES_OPTION) {
            boolean eliminado = objControladorCRUDEst.eliminarRegistro(numControl);

            if (eliminado) {
                JOptionPane.showMessageDialog(this, "Registro eliminado correctamente.");
                limpiarCampos();
                des_habilitaComponentes(false);
                objControladorCRUDEst.llenarTabla(); // refresca tabla
            } else {
                JOptionPane.showMessageDialog(this, "No se encontró el estudiante. No se eliminó nada.");
            }
        }
    }
